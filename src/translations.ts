...
export const translations: Record<SupportedLanguage, TranslationBundle> = {
  de: {
    ...
    sec02Pill1Desc: "Tees, Heilmittel in Flaschen, Bäder, Salben, Techniken, natürliche Ressourcen, Insekten, Lebensmittel, Kompressen und weiteres traditionelles Wissen.",
  ...
  pt: {
    ...
    sec02Pill1Desc: "Chás, remédios em garrafa, banhos, pomadas, técnicas, recursos naturais, insetos, alimentos, compressas e outros conhecimentos tradicionais.",
  ...
  en: {
    ...
    sec02Pill1Desc: "Teas, bottled elixirs, healing baths, salves, botanical techniques, natural resources, and ancestral wisdom.",
  ...
  es: {
    ...
    sec02Pill1Desc: "Tés, elixires embotellados, baños, pomadas, técnicas botánicas, cataplasmas y saber ancestral.",
  ...
  fr: {
    ...
    sec02Pill1Desc: "Tisanes, élixirs en bouteille, bains bienfaisants, onguents, cataplasmes et savoir traditionnel préservé.",
